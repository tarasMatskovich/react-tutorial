export const FETCH_QUIES_START = 'FETCH_QUIZES_START';
export const FETCH_QUIES_SUCCESS = 'FETCH_QUIZES_SUCCESS';
export const FETCH_QUIES_ERROR = 'FETCH_QUIZES_ERROR';
